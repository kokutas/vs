 ...
 * @Email: xxx
 * @Phone: xxx
 * @Date: 2022-04-18 04:50:40
 * @LastEditors: kokutas
 * @LastEditTime: 2022-04-18 04:50:40
 * @FilePath: /api/pkg/log/log.go
...
func NewZapLogger() *zap.Logger {
	level := viper.GetString("API_LOG_LEVEL")
	...
	return NewLogger(
		SetPath(viper.GetString("API_LOG_DIR")),
		SetPrefix(viper.GetString("API_LOG_PREFIX")),
		SetDevelopment(viper.GetBool("API_LOG_DEVELOPMENT")),
		SetDebugFileSuffix(viper.GetString("API_LOG_DEBUG_FILE_SUFFIX")),
		SetWarnFileSuffix(viper.GetString("API_LOG_WARN_FILE_SUFFIX")),
		SetErrorFileSuffix(viper.GetString("API_LOG_ERROR_FILE_SUFFIX")),
		SetInfoFileSuffix(viper.GetString("API_LOG_INFO_FILE_SUFFIX")),
		SetMaxAge(viper.GetInt("API_LOG_MAX_AGE")),
		SetMaxBackups(viper.GetInt("API_LOG_MAX_BACKUPS")),
		SetMaxSize(viper.GetInt("API_LOG_MAX_SIZE")),
		SetLevel(logLevel),
	)
}
