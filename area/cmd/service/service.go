...
import (
	...
	grpc "github.com/kokutas/vs/area/pkg/grpc"
...
var fs = flag.NewFlagSet("area", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("area", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		area.RegisterAreaServiceServer(baseServer, grpcServer)
